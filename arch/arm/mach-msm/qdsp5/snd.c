...
/*++ Kevin Shiu - 20130116 implement mic test  ++*/
	case SND_SET_INFO:
		...
		imsg.args.primary_mic = cpu_to_be32(info.primary_mic);
		imsg.args.recordFromMic2 = cpu_to_be32(info.recordFromMic2);
		imsg.args.cb_func = -1;
		imsg.args.client_data = 0;
		
		MM_INFO("snd_set_info %d %d %d\n",imsg.args.secondary_mic, imsg.args.primary_mic, imsg.args.recordFromMic2);
